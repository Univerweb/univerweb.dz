...
<template>
  <button class="switcher" :aria-label="t(`colorMode.${color.preference}`)" type="button" @click="toggleDark">
    ...
    <svg v-else xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" aria-hidden="true" viewBox="0 0 24 24" role="img">
