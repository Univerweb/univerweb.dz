...
<template>
  <header>
    ...
    <NuxtLink :to="localePath('/')" :title="t('name')">
      <svg v-if="isArabic" xmlns="http://www.w3.org/2000/svg" width="155.07" height="24" aria-hidden="true" viewBox="0 0 155.07 24" role="img" class="logo">
